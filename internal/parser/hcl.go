...
// ParseHCL reads a model written in HCL. It reports every fault as a
// diagnostic and returns whatever it could recover, as Parse does.
func ParseHCL(source string, filename string) (*ast.Model, []*diagnostic.Entry) {
